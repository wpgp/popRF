...
#' @param verbose If FALSE then the progress will be shown
#' @param log If FALSE then the progress will be shown
#' @rdname check_result_int
#' @return Number of mean difference
#' @noRd 
check_result_int <- function(input_poptables, 
                             censusmaskPathFileName, 
                             rfg.output.path.countries, 
                             nrpoc,  
                             rfg.countries.tag, 
  ...
  file.path.csv <- file.path(rfg.output.path.countries, 
                             paste0("check_result_prj_",rfg.countries.tag,"_int.csv"))
...
#' check_result_constrained_int comper input with output for integer constrain version
#' 
#' @param input_poptables Input list of pop tables
#' @param censusmaskPathFileName path to census mask raster file
#' @param rfg.output.path.countries output dir
...
#' @param verbose If FALSE then the progress will be shown
#' @param log If FALSE then the progress will be shown
#' @rdname check_result_constrained_int
#' @return Number of mean difference
#' @noRd 
check_result_constrained_int <- function(input_poptables, 
                                         censusmaskPathFileName, 
                                         rfg.output.path.countries, 
                                         nrpoc, 
                                         rfg.countries.tag, 
  ...
  file.path.csv <- file.path(rfg.output.path.countries, 
                             paste0("check_result_prj_",rfg.countries.tag,"_const_int.csv"))
